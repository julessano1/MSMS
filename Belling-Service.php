   ...
   <section class="col-md-9 content">
    <div class="box box-success">
      ...
      Available Patient  
        ...
        <div class="box-body" style="overflow: auto;">
          <table id="example1" class="table table-bordered table-striped">
                ...
                <tr style="font-size:15px;">
                    ...
                    <th><span class="label label-success"> patient ID Number </span></th>
                  <th><span class="label label-success"> Patient Insurance </span></th>
               <th><span class="label label-success">Article Name </span></th>
                  
                  <th><span class="label label-success">  Article Type </span></th>
                    <th><span class="label label-success"> Quantite Price </span></th>
        ...
        $stms_prod_EmployeeName = $conn->query("SELECT patient.patientName,patient.patientIDNumber,patient.patientLocation,patient.Phone,patient.Quantity,patient.Date,insurance.insuranceName,medecine.DragName,articletype.ArticleTypeName FROM patient INNER JOIN insurance ON patient.insuranceID=insurance.insuranceID INNER JOIN medecine ON patient.MedecineID=medecine.MedecineID INNER JOIN articletype ON patient.articletypeID=articletype.articletypeID
...
//Display All employee
            ...
            <td><?php echo  $patientIDNumber; ?></td>
            <td><?php echo $insuranceName; ?></td>
            <td><?php echo " "; ?></td>
           <td><?php echo $ArticleTypeName; ?></td>
            <td><?php echo $Quantity." "."Rwfrs"; ?></td>
