            ...
            $ServedStartDate= $_POST['ServedStartDate'];
            $ServedndDate=$_POST['ServedndDate'];
            ob_start();
...
//           $pdf->Image('../img/favicon.jpg',$x,$y,23);
           ...
           //$pdf->setLineWidth(1);
            ...
            $pdf->Text($x+35,$y+58,'Patient Served Report ');
            ...
            $pdf->Text($x+25,$y+67,'Patient Name');
            $pdf->Text($x+62,$y+67,'Patient ID Number ');
//            $pdf->Text($x+110,$y+67,' bbbb ');
            $pdf->Text($x+99,$y+67,'Medecine  ');
            //		
            ...
            $pdf->Text($x+$xx,$y+$yy,$patientName);// Display tMemberName
            $pdf->Text($x+51+$xx,$y+$yy,$ID);// Display MemberID_No
            $pdf->Text($x+92+$xx,$y+$yy,$MedecineID);// Display Contribution
            $pdf->SetFont('Arial','B',8);
            $pdf->SetTextColor(255,0,0);
//            $pdf->Text($x+90+$xx,$y+$yy+4,$UnitNumber);//Display Status 
            $pdf->SetFont('Arial','',11);
            $pdf->SetTextColor(0,0,0);
            $pdf->Text($x+120+$xx,$y+$yy,$Date);// Display Reception Date
