...
//            $pdf->Text($x+110,$y+67,' bbbb ');
            ...
            // SELECTION STATEMENT
             ...
             $stms_icome = $conn->query(" SELECT patient.patientName,patient.patientIDNumber,patient.PatientID,patient.PayedDate,patient.patientLocation,patient.Phone,patient.InsuranceID,patient.MedecineID,patient.Nationality,patient.Province,patient.Nationality,patient.District,patient.Sector,patient.articletypeID, patient.Quantity,patient.status,patient.Date, medecine.DragName,medreception.MedreceptionID,medreception.ItemUnit,medreception.UnitNumber,medreception.UnitPrice,medreception.ExperidDate FROM patient INNER JOIN medecine ON patient.MedecineID=medecine.MedecineID INNER JOIN medreception ON medecine.MedecineID=medreception.MedecineID WHERE   patient.patientIDNumber='$PatientID' AND patient.status='Payed'   ");
                   echo $conn->error;
...
//                $PatientID=$rows['PatientID'];
          ...
          $pdf->Text($x+51+$xx,$y+$yy,$PayedDate);// Display MemberID_No
