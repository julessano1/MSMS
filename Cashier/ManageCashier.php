   ...
   <section class="col-md-9 content">
    <div class="box box-success">
       ...
       Cashier Management 
        ...
        $stms_prod_EmployeeName = $conn->query("SELECT employee.EmployeeName,employee.ID,employee.Adress,employee.Phone,employee.Email,employee.Date,role.RoleName FROM employee INNER JOIN role ON employee.RoleID=role.RoleID
                    ");
