...
<div class=" box box-success ">
            <div class="box-body" style="overflow: auto;"width="500px">
              <form role="form" method="POST"action="saveSupplier.php">
               <div class="row">
                <h4 class="box-title"style="margin-left:170px;">
                    <span class="label label-success" >
                Adding New Supplier Form
                </span>
                </h4>
               ...
               <input type="hidden" value="<?php echo $date;?>" class="form-control" name="Date"
                  ...
                  <label> Full Name</label>
                     <div class="input-group">
                         <input type="text" class="form-control"  style="width:250px;border-radius:5px" name="SupplierName"required placeholder="Enter Employee full Name">
                      </div>
