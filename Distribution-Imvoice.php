...
//           $pdf->Image('../img/favicon.jpg',$x,$y,23);
           ...
           //$pdf->setLineWidth(1);
            ...
            $pdf->Text($x+35,$y+58,'Distribution Invoice ');
            ...
            $pdf->Text($x+10,$y+67,'Patient Name');
            $pdf->Text($x+62,$y+67,'Medecine Name ');
//          $pdf->Text($x+110,$y+67,' Article Type ');
            $pdf->Text($x+99,$y+67,'Drag Quantity ');
            //		
            
            $pdf->Text($x+128,$y+67,'Amount');
            ...
            // SELECTION STATEMENT
             ...
             $stms_Invoice = $conn->query("SELECT * FROM distributed ORDER BY 	DistributedID DESC LIMIT 1 
              ");
                   echo $conn->error;
                            $row_count_Invoice = $stms_Invoice->num_rows;
                            if ($row_count_Invoice > 0)
                                {							
                                $i=1;
                                $xx=10;
                                $yy=75;
                                ...
                                // $totQuant=0;
                                // $totPrice=0;
                                while ($rows = $stms_Invoice->fetch_assoc()) {
...
//                    $ReceptDate=$rows['Date'];							
            ...
            $pdf->Text($x+51+$xx,$y+$yy,$MedName);// Display MemberID_No
            $pdf->Text($x+92+$xx,$y+$yy,$Quantity);// Display Contribution
