       ...
       <?php
        ...
        <button type="submit" name="FindExisting" class="btn btn-success" id="submt"> Find Patient Info</button></span>
            ...
            if (isset($_POST['FindExisting'])){
             ...
             $sql_insurance= "SELECT patient.patientName,patient.District,patient.Phone,patient.Date,patient.patientIDNumber,patient.InsuranceID,medecine.DragName FROM `patient` INNER JOIN medecine ON patient.MedecineID=medecine.MedecineID
