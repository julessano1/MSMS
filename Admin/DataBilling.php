  ...
  <div class="box box-danger">
        ...
        <div class="box-body">
          <div class="row">
            ...
            <input type="hidden" class="form-control" value="<?php echo "$PatientID";?>" readonly name="PatientID" style="width:150px;">
        ...
        <input type="hidden" class="form-control" value="<?php echo $patientIDNumber;?>" readonly name="patientIDNumber" style="width:150px;">
      ...
      <div class="box-footer">
         <button type="submit" name="Approve_Distribution"class="btn btn-success" id="submt" style=" background-color: #4CAF50;"> Approve Distribution</button>
        </div></td></tr></table>
        </center>
